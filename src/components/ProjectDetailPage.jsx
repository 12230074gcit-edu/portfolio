...
import StickyPhoneMockup from './PhoneMockup';
...
const projectsData = {
  qube: {
    ...
    // Add your QUBE app screenshots here - replace these paths with your actual images
    appScreens: [
      '/qube-screen-1.png',
      '/qube-screen-2.png', 
      '/qube-screen-3.png',
  ...
  tovo: {
    ...
    // Add your TOVO app screenshots here - replace these paths with your actual images
    appScreens: [
      '/tovo-screen-1.png',
      '/tovo-screen-2.png',
      '/tovo-screen-3.png',
...
export default function ProjectDetailPage() {
  ...
  return (
    ...
    >
      ...
      {/* Sticky 3D Phone Mockup - floats on the right as you scroll (only for QUBE and TOVO) */}
      {(project.id === 'qube' || project.id === 'tovo') && project.appScreens && (
        <StickyPhoneMockup 
